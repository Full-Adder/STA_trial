...
def get_parser():
    ...
    # parser.add_argument("--Video_path", type=str, default=r"/media/ubuntu/Data/AVE_Dataset/Video")
    ...
    parser.add_argument("--batch_size", type=int, default=128)   # train 3090:S-64 SA-48 ST-20       test:2060:S-128
